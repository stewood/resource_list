...
from directory.models import AuditLog, Resource, ResourceVersion
...
def handle_resource_save(
    sender: Any, instance: Resource, created: bool, **kwargs: Any
) -> None:
    ...
    if created:
        change_type = "create"
        changed_fields = (
            list(instance._state.fields_cache.keys())
...
def prevent_version_updates(
    sender: Any, instance: ResourceVersion, **kwargs: Any
) -> None:
