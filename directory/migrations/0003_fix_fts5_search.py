...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            # Create FTS5 virtual table with simpler structure
            sql="""
        ...
        migrations.RunSQL(
            ...
            sql="""
            CREATE TRIGGER IF NOT EXISTS resource_fts_insert AFTER INSERT ON directory_resource
            BEGIN
        ...
        migrations.RunSQL(
            ...
            sql="""
            CREATE TRIGGER IF NOT EXISTS resource_fts_update AFTER UPDATE ON directory_resource
            BEGIN
        ...
        migrations.RunSQL(
            ...
            sql="""
            CREATE TRIGGER IF NOT EXISTS resource_fts_delete AFTER DELETE ON directory_resource
            BEGIN
