...
def find_random_draft():
    ...
    if not draft_resources.exists():
        print("❌ No draft resources found!")
        return None
...
def main():
    ...
    print("🔍 Finding a random draft resource...")
    ...
    if args.show_only:
        print("\n✅ Resource displayed. Use --data or --data-file to update it.")
        return
    ...
    if args.data:
        ...
        print("💡 Tip: Use --show-only to just display the resource without updating")
        return
